...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('category.index')}}">Kategori</a> <a href="{{route('category.create')}}" class="current">Tambah Kategori</a> </div>
            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="{{route('category.store')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <label class="control-label">Lavel Kategori:</label>
                        ...
                        <div class="control-group{{$errors->has('url')?' has-error':''}}">
                            <label class="control-label">URL (http://) :</label>
                            <div class="controls">
                        ...
                        <div class="control-group{{$errors->has('status')?' has-error':''}}">
                            <label class="control-label">Aktifkan :</label>
                            <div class="controls">
