...
class CouponController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('message','Berhasil Menambah Kupon');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('coupon.index')->with('message','Kupon Telah Diedit!');
    }
    ...
    public function destroy($id)
    {
        ...
        return back()->with('message','Berhasil Menghapus Kupon!');
    }
