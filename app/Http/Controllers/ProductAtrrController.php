...
class ProductAtrrController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('message','Berhasil Menambah Atrribut');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with('message','Attribut Berhasil Diperbarui');
    }
    ...
    public function deleteAttr($id){
        ...
        $deleteAttr->delete();
        return back()->with('message','Berhasil Menghapus Attribut!');
    }
}
