...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request,$id){
        ...
        if($inputToCart['size']==""){
            ...
            // $stockAvailable =  Cart_model::find($id);
            ...
            if($stockAvailable->stock>=$inputToCart['quantity']){
                ...
                if($count_duplicateItems>0){
                    return back()->with('message','Produk ini telah Ditambah');
                }else{
                    Cart_model::create($inputToCart);
                    return back()->with('message','Berhasil Ditambahkan Ke keranjang');
                }
            }else{
    ...
    public function updateQuantity($id,$quantity){
        ...
        if($stockAvailable->stock>=$updated_quantity){
            ...
            return back()->with('message','Kuantitas Telah Diperbarui');
        }else{
            return back()->with('message','Stok Tidak Tersedia!');
        }
