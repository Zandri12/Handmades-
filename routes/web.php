...
Route::get('/datapennguna','OrdersController@data');
...
//Penjual Produk
Route::get('/produk','HomeController@penjual_menu');
///Detail_pembelian(Admin)
Route::get('/data_pembelian','OrdersController@data_pembelian_menu');
Route::get('admin/delete-data/{id}','OrdersController@destroy');
///Users(Admin)
Route::get('/users','UsersController@akun');
Route::get('admin/delete-akun/{id}','UsersController@destroy');

Route::get('/main','OrdersController@graph');
