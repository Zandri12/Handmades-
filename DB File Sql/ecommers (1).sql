...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2020 at 02:22 PM
...
(9, '2018_12_03_043804_add_more_fields_to_users_table', 1),
(10, '2018_12_03_093548_create_delivery_address_table', 1),
(11, '2018_12_05_024718_create_orders_table', 1);
...
CREATE TABLE `users` (
  ...
  `penjual` tinyint(4) DEFAULT NULL,
  `remember_token` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
